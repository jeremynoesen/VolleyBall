                                            ...
                                            if (court != null && args[2].equalsIgnoreCase("set")) {
                                                switch (args[3].toLowerCase()) {
                                                    ...
                                                    case "enabled":
                                                        ...
                                                        break;
                                                    case "hints":
                                                        if (player.hasPermission("volleyball.court.set.hints")) {
                                                            boolean hints = Boolean.parseBoolean(args[4]);
                                                            court.setHints(hints);
                                                            player.sendMessage(Message.SUCCESS_SET_COURT_HINTS
                                                                    .replace("$COURT$", args[1])
                                                    ...
                                                    case "restrictions":
                                                        ...
                                                        break;
                                                    case "scoring":
                                                        if (player.hasPermission("volleyball.court.set.scoring")) {
                                                            boolean scoring = Boolean.parseBoolean(args[4]);
                                                            court.setScoring(scoring);
                                                            player.sendMessage(Message.SUCCESS_SET_COURT_SCORING
                                                                    .replace("$COURT$", args[1])
